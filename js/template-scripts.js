...
var slideIndex = 0;
showSlides();
$('.item span').css('background-color', 'rgb(255, 255, 255)');
...
function showSlides() {
    ...
    slideIndex++;
      ...
      if (slideIndex> slides.length) {slideIndex = 1;slides[8].style.display = "none";slides[7].style.display = "none";}
      slides[slideIndex-1].style.display = "block";
    if (slideIndex > 4) { setTimeout(showSlides, 5000);}else {
